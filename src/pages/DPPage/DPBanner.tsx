    ...
    <div className="relative min-h-screen overflow-hidden bg-gray-100">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-12 lg:px-8 pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-8 sm:pb-12 md:pb-16 min-h-[70vh] sm:min-h-[75vh] md:min-h-[70vh] lg:min-h-[80vh]">
          ...
          <button className='px-10 py-3 text-base font-medium text-white transition-all duration-300 transform bg-black shadow-lg rounded-xl hover:bg-gray-800 hover:scale-105 hover:shadow-xl active:scale-95'>
            Time To Get Cooking!
          </button>
        </div>
