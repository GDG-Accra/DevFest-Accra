...
export const AboutSection = () => {
  return (
    <section className="w-full relative flex flex-col gap-4 px-4 lg:px-[60.5px] md:gap-5 lg:gap-6 2xl:w-[1391px] 2xl:gap-[38px] mb-52">
      <div className="flex gap-3 md:gap-4 2xl:w-[485.91px] 2xl:gap-[20px] justify-center items-center xl:justify-start">
        <h1 className="text-3xl md:text-[40px] lg:text-[50px] leading-tight md:leading-none font-inter font-bold text-[#1E1E1E] 2xl:text-[50px]">
          About
          <br className="hidden xl:block md:mb-2 lg:mb-3" />
          DevFest Accra
        </h1>
